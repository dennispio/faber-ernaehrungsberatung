    ...
    <div>
        <Helmet>
            ...
            <meta
                ...
                content="emO0oDOZUDOCG4DnmF-EI5mjJQpbo_cWBUALeJBLXog"
            />
        </Helmet>
        ...
        <CookieConsent
            ...
            style={{
                background: 'linear-gradient(to right,  #140A37, #E61E0A)',
            }}
            location="bottom"
        ...
        >
            <span style={{ fontSize: '15px' }}>
                ...
                <Link to="/legal/datenschutz">Datenschutzerklärung</Link> am
                Ende der Seite. Klicken Sie auf „Ich stimme zu“, um Cookies zu

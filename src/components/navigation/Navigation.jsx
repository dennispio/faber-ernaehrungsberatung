    ...
    <div className="navigation-container">
        <div className="navigation-flex">
            <div className="image-container">
                <Link to="/">
                    <img
                        src={logo}
                        title="Logo Ernährugsbreatung Faber"
                        alt="Logo Ernährungsberatung Faber"
                    />
                </Link>
            </div>
        ...
        <div className="burgerMenu-container">
            <Menu
                ...
                customCrossIcon={
                    <img
                        src={closeBurgerButton}
                        alt="Schließen Icon"
                        title="Schließen Icon"
                    />
                }
                right
                width="100%"
            >
                <div className="burgerMenu-logo">
                    <Link to="/">
                        <img
                            alt="Icon des Burger Menüs"
                            title="Icon des Burger Menüs"
                            src={logoBurger}
                        />
                    </Link>
                </div>

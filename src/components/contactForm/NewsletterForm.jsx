...
const NewsletterForm = () => (
    <div className="form-felder row">
        <div className="form-contacthead col-md-8 col-md-offset-2  col-xs-10 col-xs-offset-1">
            <h1>Newsletter</h1>
            <p>Trage dich jetzt in den Newsletter ein um spannende Tipps und Tricks zu erhalten, wie du deine Lebensqualität durch eine gesunde Ernährung weiter steigern kannst.</p>
        </div>
        <form
            method="GET"

          ...
          <img src={tuv} alt="Logo des Tüv süd als Auszeichnung" />
            ...
            <div className="col-xs-12 col-sm-6 col-lg-3 partner-container">
                ...
                >
                    <img
                        src={p1}
                        alt="Logo der Alex Strasser Agentur"
                        title="Logo der Alex Strasser Agentur"
                    />
                </a>
                <br />
                <a
                ...
                >
                    <img
                        src={p2}
                        alt="Logo der Akbulut Küchentechnik"
                        title="Logo der Akbulut Küchentechnik"
                    />
                </a>
                <br />
                <a
                ...
                >
                    ...
                    <img
                        src={p3}
                        alt="Logo des Tüv süd als Auszeichnung"
                        title="Logo des Tüv süd als Auszeichnung"
                    />
                </a>
            </div>
        </div>

...
const VideoPlayer = () => (
  <div className="container-full">
    ...
    <video id="background-video" playsInline muted autoPlay>
      <source src={video} media="all and (min-width: 576px)" type="video/mp4" />
      <source src={video} media="all and (min-width: 576px)" type="video/ogg" />
      Your browser does not support the video tag.
      <source src={videoMobile} media="all and (max-width: 575px)" type="video/mp4" />
      <source
        src={videoMobile}

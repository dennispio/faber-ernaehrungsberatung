                ...
                <div className="morph-component">
                    <div className="morph-header ">
                        <h2 className="farbverlauf">
                            Wir hinterfragen und schauen genauer hin:
                    ...
                    <div className="morph-background">
                        <img
                            src={bgMorph}
                            alt="Diagramm zum Vergleich von Nahrungsmitteln"
                            title="Diagramm zum Vergleich von Nahrungsmitteln"
                        />
                    </div>
                    ...
                    >
                        ...
                        <p
                            className="li-containerAll hover-effect"
                            onClick={this.allMorph}
                        >
